...
return [
    ...
    */
    ...
    'min' => [
        'array' => 'O campo :attribute não deve ter menos de :max itens.',
        'file' => 'O campo :attribute não deve ter menos de :max kilobytes.',
        'numeric' => 'O campo :attribute não deve ter menos de :max.',
        'string' => 'O campo :attribute não deve ter menos de :max caracteres.',
    ],
