...
const colorClass = reactive({
	'text-orange-700 hover:text-orange-600 dark:text-orange-300 dark:hover:text-orange-400': props.color === 'primary',
	'text-purple-700 hover:text-purple-600 dark:text-purple-300 dark:hover:text-purple-400': props.color === 'secondary',
});
</script>
