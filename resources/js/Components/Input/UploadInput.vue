...
import ImagePreview from '@/Components/Container/ImagePreview.vue';
...
<template>
	...
	<div v-if="previews.length > 0" class="mt-2">
		...
		<div class="flex flex-wrap gap-2 my-2">
			...
			/>
			<div v-else
				class="w-full border shadow-sm border-slate-500 dark:border-slate-900"
			>
